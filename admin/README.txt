...
In the apache config file (/etc/apache2/httpd.conf), there must be a Directory entry similar to the one below.
Redirecting is enabled by the third line, "AllowOverride All".
   <Directory />
